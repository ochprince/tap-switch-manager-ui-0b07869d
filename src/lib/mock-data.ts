...
export const mockSwitchData: SwitchData[] = [
  {
    id: "switch-001",
    name: "核心交换机-1",
    model: "SW-16 BUILD20240220",
    ip: "172.16.11.3",
    mac: "00-4B-CD-00-00-03",
    version: "SW-CHASSIS3.6 BUILD20240220",
    powerStatus: "on",
    maxPower: 3000,
    currentPower: 1500,
  ...
  },
  {
    id: "switch-002", 
    name: "接入交换机-2",
    model: "SW-24 BUILD20240215",
    ip: "172.16.11.4",
    mac: "00-4B-CD-00-00-04",
    version: "SW-ACCESS2.1 BUILD20240215",
    powerStatus: "on",
    maxPower: 1500,
    currentPower: 800,
  ...
  },
  {
    id: "switch-003",
    name: "汇聚交换机-3", 
    model: "SW-32 BUILD20240210",
    ip: "172.16.11.5",
    mac: "00-4B-CD-00-00-05",
    version: "SW-AGGREGATE1.8 BUILD20240210",
    powerStatus: "off",
    maxPower: 2500,
    currentPower: 0,
  ...
  },
  {
    id: "switch-004",
    name: "边缘交换机-4",
    model: "SW-12 BUILD20240205", 
    ip: "172.16.11.6",
    mac: "00-4B-CD-00-00-06",
    version: "SW-EDGE1.2 BUILD20240205",
    powerStatus: "on",
    maxPower: 800,
    currentPower: 400,
    ports: generatePorts(12, 0.4),
  },
];
